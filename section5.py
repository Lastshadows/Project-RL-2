...
if __name__ == '__main__':
    ...
    steps = 300  # max number of steps of a game (will be ignored in this configuration)
    N_FQI = 20 # Number of iteration of Q
    toolbar_width = 10
    win = 0  # number of winning games
    nb_of_games = 150 # number of episodes should change to 1000 but takes to much time
    all_win = False
    save = False
